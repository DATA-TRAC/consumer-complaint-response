...
def tree_multigram_model2(Xtr,ytr,Xv,yv):
    ...
    print(f'Train Accuracy:      {round(ytr_acc*100,4)}%')
    print(f'Validation Accuracy: {round(yv_acc*100,4)}%')
    print(f'Train Recall:        {round(tr_rec*100,4)}%')
    print(f'Validation Recall:   {round(v_rec*100,4)}%')
